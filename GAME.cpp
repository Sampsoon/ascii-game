...
void input_(int &x, int &y){
    ...
    if (input == 'w' and y > 0 and lines[y-1][x] != '|' and lines[y-1][x] != '-') y -= 1;

    else if (input == 's' and y < 12 and lines[y+1][x] != '|' and lines[y+1][x] != '-') y += 1;
        
    else if (input == 'a' and x > 0 and lines[y][x-1] != '|' and lines[y][x-1] != '-') x -= 1;
    
    else if (input == 'd' and x < 131 and lines[y][x+1] != '|' and x < 131 and lines[y][x+1] != '-') x += 1;
}
